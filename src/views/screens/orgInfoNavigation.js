                    ...
                    <View style={{flex:1}}>
                        ...
                        <View style={styles.navigation}>
                            <TouchableOpacity
                                ...
                                onPress={()=>this.props.navigation.navigate('OrgInfo',{})}>
                                <Text style={{color:'#dd2127',
                                    fontSize:16,
                                    height:20.5,
                                    marginTop:20.5,
                                    marginLeft:19,
                                    fontFamily:'hilti-roman'}}>Org Info</Text>
                            ...
                            <TouchableOpacity
                                ...
                                onPress={()=>this.props.navigation.navigate('DosDonts',{})}>
                                <Text style={{color:'#dd2127',
                                    fontSize:16,
                                    height:20.5,
                                    marginTop:21.5,
                                    marginLeft:19,
                                    fontFamily:'hilti-roman'}}>Do's & Don't</Text>
                                {/*<Image
                            ...
                            <TouchableOpacity
                                ...
                                <Text style={{color:'#dd2127',
                                    ...
                                    marginTop:19.5,
                                    marginLeft:18.5,
                                    fontFamily:'hilti-roman'}}>FAQs</Text>
                                {/*<Image
                            ...
                            <TouchableOpacity
                                ...
                                onPress={()=>this.props.navigation.navigate('OrgShare',{})}>
                                <Text style={{color:'#dd2127',
                                    fontSize:16,
                                    height:20.5,
                                    marginTop:19.5,
                                    marginLeft:18.5,
                                    fontFamily:'hilti-roman'}}>I would like to share</Text>
                                {/*<Image
                                    style={{marginTop:25.5,marginLeft:4.5}}
                                    source={require('../../assets/images/arrow_icon/arrow_mdpi.png')}
                                />*/}
